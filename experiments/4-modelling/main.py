...
CB_values =[[1,50, 100], None]#'dynamic', 1, 50, None]
retry_values = [[1, 10, 5], None]
traffic_patterns = ['static', ]#'static']
output_log_file_name = functions.get_project_root()+'/logs/exp-4-interval-50ms-load-1.4-complex.csv'
