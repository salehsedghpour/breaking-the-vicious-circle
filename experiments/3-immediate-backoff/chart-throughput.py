...
df = pd.read_csv(functions.get_project_root()+'/logs/exp-3-cb-dynamic-interval-25ms.csv')
...
plt.tight_layout()
plt.savefig(functions.get_project_root()+'/experiments/3-immediate-backoff/result-thr-cb-dynamic-interval-25ms.png')
