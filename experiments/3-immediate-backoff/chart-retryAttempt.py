...
data = df.loc[(df['traffic'] == "static-110") & (df['cb'] == 50) & (df['retry'] == "dynamic")]
...
plt.tight_layout()
plt.savefig(functions.get_project_root()+'/experiments/3-immediate-backoff/result-retry-cb-50-interval-1ms.png')
