...
output_log_file_name = functions.get_project_root()+'/logs/exp-7-1-main-3-ver.csv'
...
retry_attempts = [1, 5, 10]
retry_intervals = ['1ms', '100ms']
cb_controller = [1, 0]
retry_controller = [1, 0]
traffics = [40, 70, 100,]# 'spike']
traffic_spike = 75
                        ...
                        for retry_attempt in retry_attempts:
                            for retry_interval in retry_intervals:
                                ...
                                while int(time.time() * 1000) < log_start_time + (experiment_duration * 1000):
                                    ...
                                    time.sleep(5)
                                    func.delete_same_cbs(service_list=services_list,pc_ver_list=pc_versions)
